...
if (toDate) {
  query = query.lte(
    ...
    `${toDate}T23:59:59`
      ...
      const { data, error } = await query.order("leaveid", {
        ascending: true,
      });
...
if (toDate) {
  query = query.lte(
    ...
    `${toDate}T23:59:59`
      ...
      const { data, error } = await query.order("leadid", {
        ascending: true,
      });
...
if (toDate) {
  query = query.lte(
    ...
    `${toDate}T23:59:59`
      ...
      const { data, error } = await query.order("supplierid", {
        ascending: true,
      });
...
if (toDate) {
  query = query.lte(
    ...
    `${toDate}T23:59:59`
      ...
      const { data, error } = await query.order("categoryid", {
        ascending: true,
      });
...
if (toDate) {
  query = query.lte(
    ...
    `${toDate}T23:59:59`
      ...
      const { data, error } = await query.order("productid", {
        ascending: true,
      });
...
if (toDate) {
  query = query.lte("createdat", `${toDate}T23:59:59`);
      ...
      const { data, error } = await query.order("opportunityid", {
        ascending: true,
      });
